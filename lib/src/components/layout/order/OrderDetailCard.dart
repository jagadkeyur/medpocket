                ...
                children: [
                  ...
                  Expanded(
                      ...
                      child: Text(
                        value,
                        style: themeData.textTheme.titleMedium?.copyWith(
                            color: Colors.black54, fontSize: active ? 24 : 16),
                      )),
                ],
              ),
            ),
    ...
    return CardWrapper(
      ...
      child: Column(
        ...
        children: [
          ListTile(
            title: Text(
              widget.item['stockiest_id'].toString(),
          ...
          renderRow(
              ...
              label: "Total",
              value:
                  "₹ ${(double.parse(widget.item['MRP']) * widget.item['quantity']!).toStringAsFixed(2).toString()}",
              active: true),
        ],
      ),
    );
